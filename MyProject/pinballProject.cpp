...
class MyProject : public BaseProject {
    ...
    void localInit() {
        ...
        DS_Puller.init(this, &DSLobj, {
                    {0, UNIFORM, sizeof(UniformBufferObject), nullptr},
                    {1, TEXTURE, 0, &T_Pinball}
                });
        
        M_Flipper.init(this, MODEL_PATH + "RightFlipper.obj");
        DS_LeftFlipper.init(this, &DSLobj, {
                    {0, UNIFORM, sizeof(UniformBufferObject), nullptr},
                    {1, TEXTURE, 0, &T_Pinball}
                });
        DS_RightFlipper.init(this, &DSLobj, {
                    {0, UNIFORM, sizeof(UniformBufferObject), nullptr},
                    {1, TEXTURE, 0, &T_Pinball}
                });
        
        M_Button.init(this, MODEL_PATH + "RightButton.obj");
        DS_LeftButton.init(this, &DSLobj, {
                    {0, UNIFORM, sizeof(UniformBufferObject), nullptr},
                    {1, TEXTURE, 0, &T_Pinball}
                });
        DS_RightButton.init(this, &DSLobj, {
                    {0, UNIFORM, sizeof(UniformBufferObject), nullptr},
                    {1, TEXTURE, 0, &T_Pinball}
                });
        
        M_Ball.init(this, MODEL_PATH + "Ball.obj");
        DS_Ball.init(this, &DSLobj, {
                    {0, UNIFORM, sizeof(UniformBufferObject), nullptr},
                    {1, TEXTURE, 0, &T_Pinball}
                });
        
        M_Score.init(this, MODEL_PATH + "DL6.obj");
        DS_DL1.init(this, &DSLobj, {
                    {0, UNIFORM, sizeof(UniformBufferObject), nullptr},
                    {1, TEXTURE, 0, &T_Pinball}
                });
        DS_DL2.init(this, &DSLobj, {
                    {0, UNIFORM, sizeof(UniformBufferObject), nullptr},
                    {1, TEXTURE, 0, &T_Pinball}
                });
        DS_DL3.init(this, &DSLobj, {
                    {0, UNIFORM, sizeof(UniformBufferObject), nullptr},
                    {1, TEXTURE, 0, &T_Pinball}
                });
        DS_DL4.init(this, &DSLobj, {
                    {0, UNIFORM, sizeof(UniformBufferObject), nullptr},
                    {1, TEXTURE, 0, &T_Pinball}
                });
        DS_DL5.init(this, &DSLobj, {
                    {0, UNIFORM, sizeof(UniformBufferObject), nullptr},
                    {1, TEXTURE, 0, &T_Pinball}
                });
        DS_DL6.init(this, &DSLobj, {
                    {0, UNIFORM, sizeof(UniformBufferObject), nullptr},
                    {1, TEXTURE, 0, &T_Pinball}
                });
        DS_DR1.init(this, &DSLobj, {
                    {0, UNIFORM, sizeof(UniformBufferObject), nullptr},
                    {1, TEXTURE, 0, &T_Pinball}
                });
        DS_DR2.init(this, &DSLobj, {
                    {0, UNIFORM, sizeof(UniformBufferObject), nullptr},
                    {1, TEXTURE, 0, &T_Pinball}
                });
        DS_DR3.init(this, &DSLobj, {
                    {0, UNIFORM, sizeof(UniformBufferObject), nullptr},
                    {1, TEXTURE, 0, &T_Pinball}
                });
        DS_DR4.init(this, &DSLobj, {
                    {0, UNIFORM, sizeof(UniformBufferObject), nullptr},
                    {1, TEXTURE, 0, &T_Pinball}
                });
        DS_DR5.init(this, &DSLobj, {
                    {0, UNIFORM, sizeof(UniformBufferObject), nullptr},
                    {1, TEXTURE, 0, &T_Pinball}
                });
        DS_DR6.init(this, &DSLobj, {
                    {0, UNIFORM, sizeof(UniformBufferObject), nullptr},
                    {1, TEXTURE, 0, &T_Pinball}
                });
    ...
    void updateUniformBuffer(uint32_t currentImage) {
        ...
        gubo.view = glm::lookAt(glm::vec3(0.0f, 17.0f, -15.0f) ,
                                glm::vec3(0.0f, 7.0f, 0.0),
